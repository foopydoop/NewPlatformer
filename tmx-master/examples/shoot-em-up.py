...
class Player(pygame.sprite.Sprite):
    ...
    def update(self, dt, game):
        ...
        if key[pygame.K_RSHIFT] and not self.gun_cooldown:
            if self.direction > 0:
        ...
        #afterblock_image = pygame.image.load('afterblock.png')
        #for cell in game.tilemap.layers['triggers'].collide(new, 'block'):
        #    for block in self.tilemap.layers['triggers'].find('block'):
        #        self.tilemapblock.px, block.py
